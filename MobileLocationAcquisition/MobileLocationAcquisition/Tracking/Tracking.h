 ...
 */
@property (nonatomic, unsafe_unretained) BMKMapView *mapView;
 ...
 */
@property (nonatomic, strong, readonly) BMKPointAnnotation *annotation;

/*!
 @brief 轨迹对应的overlay
 */
@property (nonatomic, strong, readonly) BMKPolyline *polyline;
